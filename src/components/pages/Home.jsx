...
export default function Home() {
    return (
        <section className="mb-2w-full flex items-center justify-center font-poppins p-14">
            <div className="w-full sm:w-6/12 ml-5 p-2">
                <h1 className="mb-5 text-3xl">Bem-Vindo ao <span className="text-mcpf-yellow font-bold">INVENTORY - MCPF</span></h1>
